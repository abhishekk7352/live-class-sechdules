...
let nm = "Numerical Method (P.Bairi)";
let mp = "DBMS (Banani Ghosh)";
let a = "Computer Network(Manasija sir)";
let ac = "Image Processing (Tauseef sir)";
let ae = "Data Mining (M.ghosh)";
let ee = "E-Commerce & ERP (Bidyut sir)";
let lab1 = "Group A-Cn lab group b dbms lab";
let lab2 = "Group a dbms lab group b cn lab";
let lab = "Lab";
...
let routine = {
    1: [{ timeStart: 1000, timeEnd: 1050, sub: mp },
    { timeStart: 1050, timeEnd: 1140, sub: ac },
    { timeStart: 1140, timeEnd: 1230, sub: ee},
    { timeStart: 1230, timeEnd: 1020, sub: nm },
    { timeStart: 1020, timeEnd: 1500, sub: b},
    { timeStart: 1500, timeEnd: 1550, sub: ae },
    { timeStart: 1550, timeEnd: 1640, sub: free },
    { timeStart: 1640, timeEnd: 1730, sub: free }],


    2: [{ timeStart: 1000, timeEnd: 1050, sub: lab1 },
    { timeStart: 1050, timeEnd: 1140, sub: lab1 },
    { timeStart: 1140, timeEnd: 1230, sub: lab1 },
    { timeStart: 1230, timeEnd: 1020, sub: lab1},
    { timeStart: 1020, timeEnd: 1500, sub: b },
    { timeStart: 1500, timeEnd: 1550, sub: mp },
    { timeStart: 1550, timeEnd: 1640, sub: a},
    { timeStart: 1640, timeEnd: 1730, sub: ae }],

    3: [{ timeStart: 1000, timeEnd: 1050, sub: lab2 },
    { timeStart: 1050, timeEnd: 1140, sub: lab2 },
    { timeStart: 1140, timeEnd: 1230, sub: lab2 },
    { timeStart: 1230, timeEnd: 1020, sub: lab2},
    { timeStart: 1020, timeEnd: 1500, sub: b },
    { timeStart: 1500, timeEnd: 1550, sub: a },
    { timeStart: 1550, timeEnd: 1640, sub: mp},
    { timeStart: 1640, timeEnd: 1730, sub: men }],


    4: [{ timeStart: 1000, timeEnd: 1050, sub: a },
    { timeStart: 1050, timeEnd: 1140, sub: nm},
    { timeStart: 1140, timeEnd: 1230, sub:ee  },
    { timeStart: 1230, timeEnd: 1020, sub: nm },
    { timeStart: 1020, timeEnd: 1500, sub: b },
    { timeStart: 1500, timeEnd: 1550, sub: free},
    { timeStart: 1550, timeEnd: 1640, sub: free},
    { timeStart: 1640, timeEnd: 1730, sub: free}],

    5: [{ timeStart: 1000, timeEnd: 1050, sub: ac },
    { timeStart: 1050, timeEnd: 1140, sub: nm },
    { timeStart: 1140, timeEnd: 1230, sub: ee },
    { timeStart: 1230, timeEnd: 1020, sub: ae },
    { timeStart: 1020, timeEnd: 1500, sub: b},
    { timeStart: 1500, timeEnd: 1550, sub: free },
    { timeStart: 1550, timeEnd: 1640, sub: free},
    { timeStart: 1640, timeEnd: 1730, sub: free },
